        ...
        <footer className="footer">
          <div className="row">
            ...
            <div className="col-1-of-2">
              ...
              <a
                href="https://www.linkedin.com/in/miiaharja/"
                className="footer__icon-link"
                rel="noopener noreferrer"
                target="_blank"
              >
              ...
              <p className="footer__copyright">
                Copyright &copy; Miia Harja 2022.
              </p>
            </div>
          </div>
        </footer>
