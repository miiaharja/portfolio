                ...
                <div className="row">
                    <div className="col-1-of-4">
                        <div className="skills-box">
                            <i className="fas fa-columns skills-box__icon"></i>
                            <h3 className="heading-tertiary u-margin-bottom-small"><Translate id="skills__header-1"/></h3>
                            <p className="skills-box__text">
                                <ul>
                                    ...
                                    <li className="skills-box__li">WooCommerce</li>
                                </ul>
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="col-1-of-4">
                        <div className="skills-box">
                            <i className="fas fa-code skills-box__icon"></i>
                            <h3 className="heading-tertiary u-margin-bottom-small"><Translate id="skills__header-2"/></h3>
                            <p className="skills-box__text">
                                <ul>
                                    <li className="skills-box__li">C#</li>
                    ...
                    <div className="col-1-of-4">
                        <div className="skills-box">
                            <i className="fas fa-desktop skills-box__icon"></i>
                            <h3 className="heading-tertiary u-margin-bottom-small"><Translate id="skills__header-3"/></h3>
                            <p className="skills-box__text">
                                <ul>
                    ...
                    <div className="col-1-of-4">
                        <div className="skills-box">
                            <i className="fas fa-infinity skills-box__icon"></i>
                            <h3 className="heading-tertiary u-margin-bottom-small"><Translate id="skills__header-4"/></h3>
                            <p className="skills-box__text">
                                <ul>
